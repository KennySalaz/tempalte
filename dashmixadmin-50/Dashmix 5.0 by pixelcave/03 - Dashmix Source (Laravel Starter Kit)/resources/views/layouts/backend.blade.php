            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-heading">Cruds</li>
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="true" href="#">
                                <i class="nav-main-link-icon fa fa-lightbulb"></i>
                                <span class="nav-main-link-name">Crear Crud</span>
                            </a>
                            <ul class="nav-main-submenu">
                                {{-- <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('pages/datatables') ? ' active' : '' }}"
                                        href="/pages/datatables">
                                        <span class="nav-main-link-name">Crear nuevo crud</span>
                                    </a>
                                </li> --}}
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ route('tablet.user') ? ' active' : '' }}"
                                        href="{{ route('tablet.user') }}">
                                        <span class="nav-main-link-name">Crear nuevo crud</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
