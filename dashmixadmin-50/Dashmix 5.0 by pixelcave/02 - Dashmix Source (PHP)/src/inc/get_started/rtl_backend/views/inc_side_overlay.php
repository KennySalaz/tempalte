...
<aside id="side-overlay">
  ...
  <div class="bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/various/bg_side_overlay_header.jpg');">
    <div class="bg-primary-op">
      <div class="content-header">
        <!-- User Avatar -->
        <a class="img-link ms-1" href="javascript:void(0)">
        ...
        <a class="me-auto text-white" href="javascript:void(0)" data-toggle="layout" data-action="side_overlay_close">
  ...
  <div class="content-side">
    ...
    <div class="block block-transparent pull-x pull-t">
      <ul class="nav nav-tabs nav-tabs-block nav-justified pe-0" role="tablist">
