...
<div class="bg-body-extra-light">
  <div class="content content-top text-center">
    ...
    <div class="row g-0 justify-content-center mb-6">
      <div class="col-lg-8">
        <p class="fs-5 mb-4">
        ...
        <div>
          ...
          <a class="btn btn-alt-primary px-4 py-2 m-1" href="be_pages_dashboard.php" target="_blank">
            <i class="fa fa-fw fa-rocket opacity-50 me-1"></i> Live Preview
          </a>
        </div>
      </div>
    </div>
    <div style="margin-bottom: -170px;">
      <img class="img-fluid" src="<?php echo $dm->assets_folder; ?>/media/various/promo_hero_v5.png" srcset="<?php echo $dm->assets_folder; ?>/media/various/promo_hero_v5@2x.png 2x" alt="Dashmix Promo Hero Image v5">
    </div>
  </div>
</div>
<!-- END Hero -->
...
<!-- Package -->
<div id="dm-package" class="bg-body-light">
  <div class="content content-full">
    <div class="py-5 mt-3 mt-lg-5 mb-5 text-center">
      ...
      <div class="row g-0 justify-content-center">
        <div class="col-lg-8">
          <p class="fs-lg mb-0">
            <strong>Dashmix</strong> comes packed with 2 full versions, a Laravel Starter Kit and a detailed documentation. It includes everything you need to start building the User Interface of your web application.
          </p>
        </div>
      </div>
    </div>
    <div class="row items-push-2x">
      ...
      <div class="col-md-6">
        <!-- PHP Version -->
        <div class="d-flex">
          <div class="flex-shrink-0 item item-rounded bg-xdream text-white-75 fw-semibold me-4">
      ...
      <div class="col-md-6">
        <!-- Laravel Starter Kit -->
        <div class="d-flex">
          <div class="flex-shrink-0 item item-rounded bg-xplay text-white-75 fw-semibold me-4">
      ...
      <div class="col-md-6">
        ...
        <div class="d-flex push">
          <div class="flex-shrink-0 item item-rounded bg-xwork text-white-75 fw-semibold me-4">
            <i class="fa fa-2x fa-check"></i>
          </div>
          <div class="flex-grow-1">
            <h4 class="mb-1">Get Started Pages + RTL Support</h4>
            <p class="text-muted mb-0">
...
<div id="dm-dashboards">
  <div class="content content-full">
    <div class="py-5 mt-3 mt-lg-5 text-center mb-3">
      <p class="fs-sm text-uppercase text-primary fw-bold mb-1">
        Powerful Layout
      </p>
      <h2 class="fw-bold mb-3">
      ...
      <div class="row g-0 justify-content-center">
        <div class="col-lg-8">
          <p class="fs-lg mb-0">
            You can create any dashboard design you want for your web application project with <span class="fw-semibold">Dashmix</span>. The possibilities are endless. We’ve created many different designs to give you an idea and help you build your own.
          </p>
        </div>
      </div>
    </div>
    <div class="row items-push">
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_file_hosting.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_wp_post.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_corporate_slim.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_analytics.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_chat.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_social_compact.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_travel.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_medical.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_tasks.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_hosting.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_booking.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_gaming.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_classic_boxed.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_crypto.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_banking.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_social.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_dark.php">
          <div class="block-content bg-dark">
            <div class="pt-2 px-2 pull-b">
          ...
          <div class="block-content block-content-full">
            ...
            <p class="fs-sm fw-medium text-muted mb-0">
              Dashboard with dark mode on
            </p>
          </div>
        </a>
      </div>
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_modern.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_minimal.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="db_messages.php">
      ...
      <div class="col-sm-6 col-xl-4">
        <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_dashboard.php">
          <div class="block-content bg-default">
            <div class="pt-2 px-2 pull-b">
              <img class="img-fluid" src="<?php echo $dm->assets_folder; ?>/media/various/promo_dashboard.png" srcset="<?php echo $dm->assets_folder; ?>/media/various/promo_dashboard@2x.png 2x" alt="Default Dashboard">
            </div>
          </div>
          <div class="block-content block-content-full">
            <h4 class="h6 mb-1">
    ...
    <div class="py-3 py-sm-5 px-md-7">
      <div class="block block-rounded block-transparent bg-body-light">
        <div class="block-content block-content-full">
          ...
          <div class="row g-sm">
            <div class="col-sm-6">
              <a class="block text-center bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/photos/photo19.jpg');" href="javascript:void(0)">
                <div class="block-content block-content-full bg-gd-fruit-op ratio ratio-4x3">
            ...
            <div class="col-sm-6">
              <a class="block text-center bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/photos/photo19.jpg');" href="javascript:void(0)">
                <div class="block-content block-content-full bg-gd-dusk-op ratio ratio-4x3">
                  <div class="d-flex justify-content-center align-items-center">
                    <div>
                      <i class="fa fa-2x fa-inbox text-white"></i>
                      <div class="fw-semibold mt-3 text-uppercase text-white">Inbox (2)</div>
                    </div>
                  </div>
                </div>
              </a>
      ...
      <div class="col-md-6 d-md-flex align-items-md-center">
        <a class="block block-rounded block-link-pop w-100 my-3 bg-image text-center" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/photos/photo18.jpg');" href="javascript:void(0)">
          <div class="block-content block-content-full bg-white-90">
            ...
            <p class="fs-lg fw-semibold text-black mb-0 mt-2"><?php $dm->get_name('male'); ?></p>
            <p class="text-black-75 fw-medium mb-0">
              Web Developer
            </p>
          </div>
            ...
            <div class="row g-0 fs-sm text-center">
              <div class="col-4">
                <a class="text-muted fw-semibold" href="javascript:void(0)">
                  <i class="fa fa-fw fa-eye me-1"></i> 456
                </a>
              </div>
              <div class="col-4">
                <a class="text-muted fw-semibold" href="javascript:void(0)">
                  <i class="fa fa-fw fa-heart me-1"></i> 67
                </a>
              </div>
              <div class="col-4">
                <a class="text-muted fw-semibold" href="javascript:void(0)">
                  <i class="fa fa-fw fa-comments me-1"></i> 56
                </a>
              </div>
            </div>
          </div>
...
<!-- Smart Toolkit -->
<div id="dm-toolkit" class="bg-body-extra-light">
  <div class="content content-full">
    <div class="py-5 mt-3 mt-lg-5 text-center mb-3">
      <p class="fs-sm text-uppercase text-primary fw-bold mb-1">
        Developer Friendly
    ...
    <div class="mb-5">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 offset-md-1 d-md-flex align-items-md-center">
          <div class="block block-rounded block-fx-pop row g-0 w-100 py-4 my-3">
            <div class="col-4">
          ...
          <div class="block block-rounded block-fx-pop row g-0 w-100 py-4 my-3">
            <div class="col-4">
              <div class="item item-2x item-rounded mx-auto bg-xplay-lighter">
                <span class="fs-lg fw-bold text-xplay-dark">ES6</span>
              </div>
            </div>
            <div class="col-4 d-flex align-items-center justify-content-center">
              <div class="item item-circle bg-body-dark">
            ...
            <div class="col-4">
              <div class="item item-2x item-rounded mx-auto bg-xwork-lighter">
                <span class="fs-lg fw-bold text-xwork-dark">ES5</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="content content-full">
    ...
    <div class="mb-5">
      <div class="row py-3">
        ...
        <div class="col-md-6 offset-md-1 d-md-flex align-items-md-center">
          <div class="block block-rounded block-fx-pop row g-0 w-100 py-4 my-3 overflow-hidden">
            <div class="row g-0 text-center w-100 mb-2">
              <div class="col-4">
...
<!-- Full Featured -->
<div id="dm-features" class="bg-body-extra-light">
  <div class="content content-full">
    <div class="py-5 mt-3 mt-lg-5 text-center mb-3">
      <p class="fs-sm text-uppercase text-primary fw-bold mb-1">
        Limitless
